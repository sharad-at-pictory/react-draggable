...
var Draggable = /*#__PURE__*/function (_React$Component) {
  ...
  function Draggable(props /*: DraggableProps*/) {
    ...
    _defineProperty(_assertThisInitialized(_this), "snapX", void 0);
    _defineProperty(_assertThisInitialized(_this), "snapY", void 0);
    ...
    _defineProperty(_assertThisInitialized(_this), "onDrag", function (e, coreData) {
      ...
      // sharad-at-pictory:: if snapX and snapY fn added to draggable, then call them to get the new snap position
      if (_this.snapX) {
        newState.x = _this.snapX(newState.x);
      }
      if (_this.snapY) {
        newState.y = _this.snapY(newState.y);
      }
